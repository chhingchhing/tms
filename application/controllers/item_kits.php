...
class Item_kits extends Secure_area implements iData_controller
{
	...
	function excel_export() {
		...
		$rows = array();
		$row = array(lang('items_item_number'),lang('item_kits_name'),lang('items_category'),lang('items_supplier_id'),lang('items_cost_price'),lang('items_unit_price'),lang('items_tax_1_name'),lang('items_tax_1_percent'),lang('items_tax_2_name'),lang('items_tax_2_percent'),lang('items_tax_2_cummulative'),lang('item_kits_description'));
	...
	*/
	...
	function view($item_kit_id=-1)
	{
		...
		$data['default_tax_1_rate']=($item_kit_id==-1) ? $this->config->item('default_tax_1_rate') : '';
		$data['default_tax_2_rate']=($item_kit_id==-1) ? $this->config->item('default_tax_2_rate') : '';
		$data['default_tax_2_cumulative']=($item_kit_id==-1) ? $this->config->item('default_tax_2_cumulative') : '';
