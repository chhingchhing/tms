...
class Detailed_sales_sms extends Report
{
	...
	public function getDataColumns()
	{
		return array(
			'summary' => array(
				...
				array('data'=>lang('reports_commission_receptionist'), 'align'=> 'left'), 
	...
	public function getData()
	{
		...
		if ($this->params['condition_master'] != 'receptionist' && $this->params['condition_master'] != null) {
  ...
  // var_dump($this->db->get()->result_array()); die();
		...
		{       
			$this->db->select('massage_name, massager_id, office, time_in, time_out, issue_date, items_massages.massage_name as name_of_massage, quantity_purchased, subtotal,total, profit, discount_percent, profit_inclod_com_price');
			$this->db->from('sales_massages_temp');
