<!-- Chhingchhing -->
<!-- Modal -->
<div class="modal fade" id="excel_import" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<h4 class="modal-title"><?php echo anchor("customers/excel", lang('customers_download_excel_import_template')); ?></h4>
<?php echo form_open_multipart('customers/do_excel_import/',array('id'=>'myForm', 'class'=>'add_update', 'role'=>'form','class'=>'form-horizontal')); ?>
