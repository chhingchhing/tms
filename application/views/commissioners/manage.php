          ...
          <!--<div class="left_tiket" style="background: #ccc ;width:100%; height: auto;background: red;">-->
            <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
                <div class="list-group">
                    ...
                    <?php } ?>
                    <?php
                    $this->load->view('commissioners/form.php');
                    ?>
                    ...
                    <?php echo anchor("$controller_name/delete", $this->lang->line("common_delete"), array('id' => 'delete_commis', 'name' => 'delete_commis', 'class' => 'list-group-item delete_inactive glyphicon glyphicon-trash')); ?>
                </div>
            </div>
