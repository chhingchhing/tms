...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <table>  
            <tr>
                <th class="col-1 col-sm-1 col-lg-1"><?php echo lang('tickets_ticket_code'); ?></th>
                <td class="col-1 col-sm-1 col-lg-1" style='text-align:left;'></span><span class='short_name'><?php echo $item_number[$item['line']-1]; ?></span></td>
            </tr>
            <tr>
            ...
            <tr>
                <th class="col-1 col-sm-1 col-lg-1"><?php echo lang("sales_quantity"); ?></th>
            ...
            <!-- <tr>
                <th class="col-1 col-sm-1 col-lg-1"><?php //echo lang("sales_total"); ?></th>
                <td class="col-1 col-sm-1 col-lg-1" style='text-align:left;'><?php //echo to_currency($item['price'] * $item['quantity'] - $item['discount']); ?></td>
            </tr> -->
            <tr>
                <th class="col-1 col-sm-1 col-lg-1"><?php echo lang("sales_seat_number"); ?></th>
                <td class="col-1 col-sm-1 col-lg-1" style='text-align:left;'><?php echo $seat_no[$item['line'] - 1]; ?></td>
            </tr>
            <!-- <tr>
                <td><?php //echo lang("sales_vol"); ?>a</td>
                <td class="col-1 col-sm-1 col-lg-1" style='text-align:left;'><?php //echo $item_vol[$item['line'] - 1]; ?></td>
            </tr> -->
            <tr>
                <th class="col-1 col-sm-1 col-lg-1"><?php echo lang("config_hotel"); ?></th>
                <td class="col-1 col-sm-1 col-lg-1" style='text-align:left;'><?php echo $hotel_names[$item['line'] - 1]; ?></td>
            </tr>
            <tr>
                <th class="col-1 col-sm-1 col-lg-1"><?php echo lang("config_room_number"); ?></th>
                <td class="col-1 col-sm-1 col-lg-1" style='text-align:left;'><?php echo $room_numbers[$item['line'] - 1]; ?></td>
            </tr>
            <tr>
                <?php 
                if ($dates_departure[$item['line']-1]=='') {
                    $dates_departure[$item['line']-1] = "0000-00-00";
                }
                if ($times_departure[$item['line']-1]=='') {
                    $times_departure[$item['line']-1] = "00:00:00";
                }
                ?>
                <th class="col-1 col-sm-1 col-lg-1"><?php echo lang("sales_date_departure"); ?></th>
                <td class="col-1 col-sm-1 col-lg-1" style='text-align:left;'><?php echo $dates_departure[$item['line'] - 1]!="0000-00-00" ? date('d/m/Y', strtotime($dates_departure[$item['line'] - 1])) : ""; ?></td>
            </tr>
            <tr>
                <th class="col-1 col-sm-1 col-lg-1"><?php echo lang("sales_time_departure"); ?></th>
                <td class="col-1 col-sm-1 col-lg-1" style='text-align:left;'><?php echo $times_departure[$item['line']-1]!="00:00:00" ? date('h:i a', strtotime($times_departure[$item['line'] - 1])) : ""; ?></td>
            </tr>
            <tr>
                <th class="col-1 col-sm-1 col-lg-1"><?php echo lang(""); ?></th>
                <td></td>
            </tr>   
        </table>
