            ...
            <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
                <div class="list-group">
                    <?php if ($this->Employee->has_module_action_permission($controller_name, 'add_update', $this->Employee->get_logged_in_employee_info()->person_id)) { ?> 
                        <?php
                        echo anchor("#tickets", lang($controller_name . '_new'), array('class' => 'list-group-item glyphicon glyphicon-plus-sign', 'title' => lang($controller_name . '_new'), 'data-toggle' => 'modal', 'data-target' => '#tickets'));
                        ?> 
                    <?php } ?>
                    <?php
                    $this->load->view('tickets/form.php');
                    ?>

                    <?php echo anchor("$controller_name/sales/" . $this->uri->segment(3), lang('tickets_sale'), array('class' => 'list-group-item none import glyphicon glyphicon-shopping-cart')); ?>
