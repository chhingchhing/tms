...
<div class="form-group">
    ...
    <div class='col-sm-10'>
        ...
        echo form_dropdown('language', array(
            ...
            //'indonesia' => 'Indonesia',
            //'spanish' => 'Spanish',
            'khmer' => 'Khmer'), $this->config->item('language'));
            //'french' => 'French'
        ?>
    </div>
</div>
...
<div class="form-group">	
    ...
    <div class='col-sm-10'>
        ...
        echo form_dropdown('date_format', array(
            ...
            'big_endian' => '2000-12-30'), $this->config->item('date_format'), 'class="form-control"');
        ?>
    </div>
</div>
...
<?php echo form_label(lang('config_default_currency_type') . ':', 'default_currency', array('class' => 'col-sm-2 control-label')); ?>
    <div class='col-sm-10'>
<?php echo form_dropdown('default_currency', $currency_options, $this->config->item('default_currency')); ?>
    </div>
</div>
<!-- Currency End -->