            ...
            <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
                <div class="list-group">
                    <?php if ($this->Employee->has_module_action_permission($controller_name, 'add_update', $this->Employee->get_logged_in_employee_info()->employee_id)) { ?> 
                        <?php
                        echo anchor("#currency/view", lang($controller_name.'_new'), array('class' => 'list-group-item glyphicon glyphicon-plus-sign add_new', 'title' => lang($controller_name . '_new'), 'id'=>'_new', 'modals'=>'currency'));
                        ?> 
                    <?php } ?>
                    <?php
                    $this->load->view('currency/form.php');
                    ?>
