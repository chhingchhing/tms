    ...
    <div  class="panel-heading" id="report">
        <table id="title_bar">
            <tr>
                ...
                <td id="title"><?php echo lang('reports_report_bikes'); ?></td>
            </tr>
        </table>
    </div>
...
<!--                <h5 class="col-md-3"><?php // echo lang('reports_bikes'); ?></h5>-->
                <ul>
                    <li class="reports summary col-md-4"><a href="<?php echo site_url('reports/summary_bikes/'.$this->uri->segment(3)); ?>"><?php echo lang('reports_summary_reports'); ?></a></li>			                 
