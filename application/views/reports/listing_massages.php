    ...
    <div  class="panel-heading" id="report">
        <table id="title_bar">
            <tr>
                ...
                <td id="title"><?php echo lang('reports_report_massages'); ?></td>
            </tr>
        </table>
    </div>
...
<!--            <li class="full"> 
            ...
            <li class="full">
                ...
                <ul>
                    <li class="reports summary col-md-4"><a href="<?php echo site_url('reports/summary_massages/'.$this->uri->segment(3)); ?>"><?php echo lang('reports_summary_reports'); ?></a></li>			
