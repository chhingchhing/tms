...
{
	var table_columns = ["","item_id","item_number",'name','category','unit_price','quantity','',''];
	...
	<tr>
		<td id="commands">
			<div id="new_button">
				...
				?>
				<?php echo anchor("$controller_name/excel_import_update/width~$form_width",
					lang('common_excel_import_update'),
					array('class'=>'thickbox none import',
						'title'=>lang('items_mass_update_excel')));
				?>
				<?php }?>
