<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <?php
            echo form_open('guides/save/'.$guide_info->guide_id, array('id' => 'guides_form', 'method' => 'post', 'class' => 'add_update', 'role' => 'form', 'class' => 'form-horizontal'));
            ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    echo form_dropdown('gender',$gender, $guide_info->gender);
                    ?>
                </div>
            </div>
            <div class="form-group">
